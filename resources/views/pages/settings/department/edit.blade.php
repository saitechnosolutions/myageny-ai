...
<main class="main-content">
    <div class="crm-page-body">
        <div class="crm-page-header">
            <div>
                <h2 class="crm-title">Edit Department</h2>
        ...
        <form method="POST" action="{{ route('settings.departments.update', $department) }}">
            ...
            <div class="crm-form-wrap">
                <div class="crm-form-head">
                    <h3 style="margin:0; font-size:16px; font-weight:700;">Department Details</h3>
                </div>
                <div class="crm-form-body">
                    <div>
                        <label class="crm-label">Department Name <span class="req">*</span></label>
                        <input type="text" name="name" class="crm-input" value="{{ old('name', $department->name) }}" required>
                    </div>
                    <div>
                        <label class="crm-label">Description</label>
                        <textarea name="description" class="crm-textarea" placeholder="Optional department description">{{ old('description', $department->description) }}</textarea>
                    </div>
                </div>
