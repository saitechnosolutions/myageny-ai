...
<main class="main-content">
    <div class="crm-page-body">
        <div class="crm-page-header">
            <div>
                <h2 class="crm-title">Edit Leave Type</h2>
            ...
            <div class="crm-form-wrap">
                ...
                <div class="crm-form-body">
                    <div>
                        ...
                        <input type="text" name="name" class="crm-input" value="{{ old('name', $leaveType->name) }}" required>
                    </div>
                    <div>
                        <label class="crm-label">Description</label>
                        <textarea name="description" class="crm-textarea" placeholder="Optional leave type description">{{ old('description', $leaveType->description) }}</textarea>
                    </div>
                </div>
