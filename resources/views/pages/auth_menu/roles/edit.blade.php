...
<div class="auth-editor">
    <div class="auth-editor-top">
        <div>
            <div class="auth-editor-title">Edit Role</div>
            <div class="auth-editor-sub">Update the role name, label, and description here. Permissions are managed on the separate access page.</div>
        </div>
