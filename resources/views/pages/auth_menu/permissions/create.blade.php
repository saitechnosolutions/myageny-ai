...
.perm-actions-grid { display:grid; grid-template-columns:repeat(auto-fit, minmax(140px, 1fr)); gap:10px; }
.perm-check-card { display:flex; align-items:center; gap:10px; border:1px solid #e1dee3; border-radius:10px; padding:10px 12px; background:#fafafa; cursor:pointer; font-size:13px; font-weight:600; color:#222; }
.perm-check-card input { margin:0; }
.perm-help { color:#8a8a8a; font-size:11px; margin-top:6px; }
...
<div class="perm-editor">
    <div class="perm-editor-top">
        <div>
            <div class="perm-editor-title">Bulk Create Permissions</div>
            <div class="perm-editor-sub">Enter one module name, use the default actions, and add custom actions whenever you need them.</div>
        </div>
